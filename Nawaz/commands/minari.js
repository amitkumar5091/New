...
const chatbot  =  new  Chatbot({name: "Minari", gender: "Najimi"});
 ...
 if(res === "My dear great botmaster, Aaryan.") {
    api.sendMessage(`I made by master 𝐌𝐑..𝐀𝐀𝐑𝐘𝐀𝐍, also known as Aaryan`, event.threadID, event.messageID)
    return;
              }   
      if(res === "My birthplace is Aaryan's laptop. What is your birthplace?") {
    ...
    return;
            ...
            if(res === "I was created by Aaryan.") {
    api.sendMessage(`I was created by Aaryan.`, event.threadID, event.messageID)
    return;
              }     
              
              if(res === "I obey 𝐌𝐑..𝐀𝐀𝐑𝐘𝐀𝐍.") {
